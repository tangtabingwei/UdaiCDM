                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo U('User/lists');?>">客户信息</a>
                                </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo U('Accept/lists');?>">贷款信息</a>
                                </li>
                                <li>
                ...
                <div class="panel-body">
                    <div class="dataTable_wrapper">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody>
                                <?php if(is_array($user_list)): foreach($user_list as $key=>$ul): ?><tr>
                    ...
                    <td>
                        <a class="btn btn-sm btn-default" href="<?php echo U('User/edit',array('id'=>$ul['id']));?>" role="button">编辑</a>
                        <a class="btn btn-sm btn-default" href="<?php echo U('User/delete',array('id'=>$ul['id']));?>" role="button">删除</a>
                    </td>
