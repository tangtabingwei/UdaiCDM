...
<ul>
<li><a href="/index.php/Home/CustomerBank/all">管理</a></li>
<li><a href="/index.php/Home/CustomerBank/add">新建</a></li>
</ul>
</li>
<li class="has_sub"><a href="#"><i class="icon-list-alt"></i> CustomerInfo<span class="pull-right"><i class="icon-chevron-right"></i></span></a>
<ul>
<li><a href="/index.php/Home/CustomerInfo/all">管理</a></li>
<li><a href="/index.php/Home/CustomerInfo/add">新建</a></li>
</ul>
</li>
<li class="has_sub"><a href="#"><i class="icon-list-alt"></i> Deal<span class="pull-right"><i class="icon-chevron-right"></i></span></a>
<ul>
<li><a href="/index.php/Home/Deal/all">管理</a></li>
<li><a href="/index.php/Home/Deal/add">新建</a></li>
</ul>
</li>
<li class="has_sub"><a href="#"><i class="icon-list-alt"></i> DealLoadRepay<span class="pull-right"><i class="icon-chevron-right"></i></span></a>
<ul>
<li><a href="/index.php/Home/DealLoadRepay/all">管理</a></li>
<li><a href="/index.php/Home/DealLoadRepay/add">新建</a></li>
</ul>
</li>
...
<thead>
<tr>	
<th><center>id</center></th><th><center>c_id</center></th><th><center>bank_name</center></th><th><center>bankcard</center></th><th><center>real_name</center></th><th><center>bankzone</center></th><td>操作</td>
</tr>
</thead>
<?php if(is_array($customer_bankList)): $i = 0; $__LIST__ = $customer_bankList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
<td><?php echo ($vo["id"]); ?></td><td><?php echo ($vo["c_id"]); ?></td><td><?php echo ($vo["bank_name"]); ?></td><td><?php echo ($vo["bankcard"]); ?></td><td><?php echo ($vo["real_name"]); ?></td><td><?php echo ($vo["bankzone"]); ?></td><td><a href="<?php echo U('CustomerBank/edit/id/'.$vo[id]);?>">编辑</a> |
<a href="<?php echo U('CustomerBank/delete/id/'.$vo[id]);?>" onclick='return confirm("确定删除吗？")'>删除</a>
</td>
