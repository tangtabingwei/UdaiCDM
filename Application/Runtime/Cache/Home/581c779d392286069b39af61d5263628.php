...
<thead>
<tr>	
<th><center>id</center></th><th><center>title</center></th><th><center>price</center></th><th><center>create_time</center></th><th><center>update_time</center></th><th><center>status</center></th><td>操作</td>
</tr>
</thead>
<?php if(is_array($goodsList)): $i = 0; $__LIST__ = $goodsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
<td><?php echo ($vo["id"]); ?></td><td><?php echo ($vo["title"]); ?></td><td><?php echo ($vo["price"]); ?></td><td><?php echo ($vo["create_time"]); ?></td><td><?php echo ($vo["update_time"]); ?></td><td><?php echo ($vo["status"]); ?></td><td><a href="<?php echo U('Goods/edit/id/'.$vo[id]);?>">编辑</a> |
<a href="<?php echo U('Goods/delete/id/'.$vo[id]);?>" onclick='return confirm("确定删除吗？")'>删除</a>
</td>
