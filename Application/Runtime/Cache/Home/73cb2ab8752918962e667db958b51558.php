...
<body>
	...
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">
				修改用户信息
				<small><?php echo ($info["mg_name"]); ?></small>
	...
	<!-- /.row -->
	<form action="/index.php/User/edit/mg_id/4.html" method="POST" class="form-horizontal" role="form">

		<div class="form-group">
			<label for="">用户名称</label>
			<input type="text" class="form-control" name="mg_name" id="mg_name" value="<?php echo ($info["mg_name"]); ?>"></div>
		<div class="form-group">
			<label for="">角色</label>
			<select name="mg_role_id" id="mg_role_id" class="form-control" >
				<?php if(is_array($rinfo)): $i = 0; $__LIST__ = $rinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if($key == $info['mg_role_id']): ?>selected = 'selected'<?php endif; ?>><?php echo ($v); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
			</select>
			</div>
		<div class="form-group">
