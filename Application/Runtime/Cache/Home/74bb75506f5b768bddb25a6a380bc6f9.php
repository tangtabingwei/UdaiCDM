		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<a href="<?php echo U('Auth/add');?>" class="btn btn-primary " role="button">新增权限</a>
							...
							<table class="table table-striped table-bordered table-hover" >
								...
								<tbody>
									<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
											...
											<td>
												<a href="<?php echo U('Auth/edit/',array('auth_id'=>$vo['auth_id']));?>">编辑</a>
												|
												<a href="<?php echo U('Auth/delete/',array('auth_id'=>$vo['auth_id']));?>" onclick='return confirm("确定删除吗？")'>删除</a>
											</td>
