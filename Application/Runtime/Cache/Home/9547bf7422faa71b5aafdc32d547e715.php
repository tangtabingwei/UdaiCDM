...
<body>
	...
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">
				修改权限
				<small><?php echo ($ainfo["auth_name"]); ?></small>
	...
	<!-- /.row -->
	<form action="/index.php/Auth/edit/auth_id/23.html" method="POST" class="form-horizontal" role="form">

		<div class="form-group">
			<label for="">权限名称</label>
			<input type="text" class="form-control" name="auth_name" id="auth_name" value="<?php echo ($ainfo["auth_name"]); ?>"></div>
		<div class="form-group">
			<label for="">权限父级</label>
			<select name="auth_pid" id="auth_pid" class="form-control" >
				<option value="0">请选择</option>
				<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if($key == $ainfo['auth_id']): ?>selected = 'selected'<?php endif; ?>  ><?php echo ($v); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
			</select>
			</div>
		<div class="form-group">
			<label for="">权限控制器</label>
			<input type="text" class="form-control" name="auth_c" id="auth_c" value="<?php echo ($ainfo["auth_c"]); ?>"></div>
		<div class="form-group">
			<label for="">权限操作方法</label>
			<input type="text" class="form-control" name="auth_a" id="auth_a" value="<?php echo ($ainfo["auth_a"]); ?>"></div>
		<div class="form-group">
