		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<a href="<?php echo U('Role/add');?>" class="btn btn-primary " role="button">新增角色</a>
							...
							<table class="table table-striped table-bordered table-hover" id="dataTables-example">
								...
								<tbody>
									<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
											...
											<td>
												<a href="<?php echo U('Role/distribute/',array('role_id'=>$vo['role_id']));?>">分配权限</a>
												|
												<a href="<?php echo U('Role/delete/',array('role_id'=>$vo['role_id']));?>" onclick='return confirm("确定删除吗？")'>删除</a>
											</td>
